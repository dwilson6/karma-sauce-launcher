...
function processConfig(config = {}, args = {}) {
    ...
    const seleniumCapabilities = Object.assign({ user: username, key: accessKey, region: config.region, headless: config.headless, logLevel: 'error', capabilities: Object.assign({ 'sauce:options': capabilitiesFromConfig }, args) }, config.options);
    return {
        startConnect,
        sauceConnectOptions,
